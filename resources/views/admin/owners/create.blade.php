                  ...
                  <div class="flex flex-wrap -m-2">
                    ...
                    <div class="p-2 w-full md:w-1/2">
                      <div class="relative">
                        ...
                        <input type="email" id="email" required name="email" value="{{old("email")}}" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-red-500 focus:bg-white focus:ring-2 focus:ring-red-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                      </div>
                    </div>
                    <div class="p-2 w-full md:w-1/2">
                      <div class="relative">
                    ...
                    <div class="flex justify-around p-2 w-full mt-6">
                      ...
                      <button type="submit" onclick="" class="text-white bg-red-500 border-0 py-2 px-8 focus:outline-none hover:bg-red-600 rounded text-lg">登録</button>
                    </div>
                  </div>
                </form>
              </div>
