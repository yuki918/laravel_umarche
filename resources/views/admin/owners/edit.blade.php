                  ...
                  <div class="flex flex-wrap -m-2">
                    ...
                    <div class="p-2 w-full md:w-1/2">
                      <div class="relative">
                        ...
                        <div class="w-full bg-gray-100 bg-opacity-50 rounded focus:bg-white focus:ring-2 focus:ring-red-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">{{ $owners->shop->name }}</div>
                      </div>
                    </div>
                    <div class="p-2 w-full md:w-1/2">
                      <div class="relative">
